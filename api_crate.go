...
func (r ApiHandleGetTelegramChatIdRequest) Execute() (string, *http.Response, error) {
...
First call this endpoint, then ask the user to send a message to the bot, then the chat id will be returned
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param username User id to get notification channels for
 @return ApiHandleGetTelegramChatIdRequest
*/
func (a *CrateApiService) HandleGetTelegramChatId(ctx context.Context, username string) ApiHandleGetTelegramChatIdRequest {
	return ApiHandleGetTelegramChatIdRequest{
		ApiService: a,
		ctx: ctx,
		username: username,
...
// Execute executes the request
//  @return string
func (a *CrateApiService) HandleGetTelegramChatIdExecute(r ApiHandleGetTelegramChatIdRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := localBasePath + "/get_telegram_chat_id/{username}"
